                    ...
                    <div class="lg:w-2/5">
                        <div class="relative overflow-hidden rounded-md bg-white dark:bg-slate-900 shadow dark:shadow-gray-800">
                            ...
                            <div class="px-6 py-12 text-center">
                                ...
                                <div class="mt-6">
                                    <router-link to="/" class="btn bg-violet-600 hover:bg-violet-700 border-violet-600 hover:border-indigobg-violet-700 text-white rounded-md">Continue</router-link>
                                </div>
                            </div>

                            <div class="text-center p-6 border-t border-gray-100 dark:border-gray-700">
                                <p class="mb-0 text-slate-400">© {{ date }} Giglink. Design with <i class="mdi mdi-heart text-red-600"></i> by <a href="https://shreethemes.in/" target="_blank" class="text-reset">Shreethemes</a>.</p>
                            </div>
                        </div>
                    </div>
                </div>
