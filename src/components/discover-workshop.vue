<template>
    <section class="relative md:py-24 py-16 bg-[#f4f4f4] text-[#1a1a1a] min-h-screen font-inter">
                    ...
                    >
                        ...
                        <div class="flex flex-col items-end sm:items-start gap-2 text-sm text-right sm:text-left mt-3 sm:mt-0">
                            <div class="flex flex-col items-center sm:items-start gap-2 text-center sm:text-left mt-3 sm:mt-0 w-full">
                                <p class="text-black-600 dark:text-white font-bold text-sm sm:text-base lg:text-lg font-inter">{{ tech.price }}</p>
                                <p class="text-slate-500 dark:text-white text-xs sm:text-sm lg:text-base font-inter">{{ tech.duration }}</p>
                                  <button
        ...
        <dialog
            v-if="selectedTech"
            class="fixed inset-0 bg-black/50 flex items-center justify-center z-50 font-inter"
        >
            <div
                class="bg-white dark:bg-slate-900 rounded-xl p-6 w-full max-w-lg relative shadow-xl font-inter"
            >
                <button
                ...
                <div class="flex items-center gap-4 mb-4">
                    ...
                    <div>
                        <h3 class="text-xl font-semibold text-slate-800 dark:text-white font-inter">
                            {{ selectedTech.name }}
                        </h3>
                        <p class="text-slate-500 font-inter">{{ selectedTech.specialization }}</p>
                        <span
                ...
                <div class="space-y-2 text-slate-600 dark:text-slate-300 font-inter">
                ...
                <button
                    class="mt-6 w-full bg-emerald-500 text-white py-2 rounded-full hover:bg-emerald-600 transition font-inter shadow font-semibold"
                >
